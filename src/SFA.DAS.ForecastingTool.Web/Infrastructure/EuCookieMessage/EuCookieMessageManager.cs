...
namespace SFA.DAS.ForecastingTool.Web.Infrastructure.EuCookieMessage
{
    public static class EuCookieMessageManager
    {
        ...
        private const string MessageHtml = "<div id=\"global-cookie-message\" style=\"display: block;\"><p>GOV.UK uses cookies to make the site simpler. <a href=\"/Privacy\" target=\"_blank\">Find out more about cookies</a></p></div>";
